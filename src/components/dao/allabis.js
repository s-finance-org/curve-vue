...
export let poolproxy_address = process.env.VUE_APP_POOLPROXY_ADDRESS
...
export let votingescrow_address = process.env.VUE_APP_VOTING_ESCROW
...
export let gaugecontroller_address = process.env.VUE_APP_GAUGE_CONTROLLER
...
export let CRV_address = process.env.VUE_APP_SFG
...
export let registry_address = process.env.VUE_APP_REGISTRY_ADDRESS
...
export let vesting_address = process.env.VUE_APP_VESTING_ADDRESS
...
export let minter_address = process.env.VUE_APP_PS_MINTER
