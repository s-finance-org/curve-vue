<template>
    ...
    <b-container>
      ...
      <b-tabs pills nav-class="tabs-nav" class="mt-4">
        ...
        <b-tab :title="$t('dao.tokenTitle', ['SFG'])" class="pt-3" active>
        ...
        <b-tab :title="$t('dao.standTitle')" class="pt-3">
          ...
          <h4 class="mb-2 d-flex flex-wrap align-items-end">
            ...
            <small class="mr-auto">{{ $t('dao.describe', [store.gauges.busd5.mortgagesUnit, store.gauges.busd5.rewardsUnit.join(' + ')]) }}</small>
          </h4>
          <div class="box mb-4 px-4 py-3">
            <div class="row mb-3 line-bottom flex-wrap align-items-center">
              <text-overlay-loading class="d-flex col-auto pb-3 col-12 col-sm-auto" inline :show="store.gauges.busd5.rewards.sfg.totalApy.loading">
                <img :src="getTokenIcon(store.gauges.busd5.rewards.sfg.code)" class="mr-2 icon-w-48 icon" :class="[store.gauges.busd5.rewards.sfg.code+'-icon']">
                <span class="d-flex h4 mb-0 flex-column">
                  <span class="h6 mb-0 inline-block text-black-65">{{ store.gauges.busd5.rewards.sfg.name }} {{ $t('global.apr') }}</span>
                  {{ store.gauges.busd5.rewards.sfg.totalApy.percent }}%
                </span>
              </text-overlay-loading>

              <!-- <span class="d-md-flex d-none flex-wrap align-items-center">
                <text-overlay-loading class="d-flex col-auto pb-3 col-12 col-sm-auto" inline :show="store.gauges.busd5.rewards.sfg.totalApy.loading || store.gauges.busd5.rewards.sfg.totalMaxApy.loading">
                  <img :src="getTokenIcon(store.gauges.busd5.rewards.sfg.code)" class="mr-2 icon-w-48 icon" :class="[store.gauges.busd5.rewards.sfg.code+'-icon']">
                  <span class="d-flex h4 mb-0 flex-column">
                    <span class="h6 mb-0 inline-block text-black-65">{{ store.gauges.busd5.rewards.sfg.name }} {{ $t('global.apr') }}</span>
                    {{ store.gauges.busd5.rewards.sfg.totalApy.percent }}% ~ {{ store.gauges.busd5.rewards.sfg.totalMaxApy.percent }}%
                  </span>
                </text-overlay-loading>
                <span class="icon-w-20 icon-plus mb-3"></span>
                <text-overlay-loading class="d-flex col-auto pb-3 col-12 col-sm-auto" inline :show="store.gauges.busd5.rewards.bnb.totalApy.loading">
                  <img :src="getTokenIcon(store.gauges.busd5.rewards.bnb.code)" class="mr-2 icon-w-48 icon" :class="[store.gauges.busd5.rewards.sfg.code+'-icon']">
                  <span class="d-flex h4 mb-0 flex-column">
                    <span class="h6 mb-0 inline-block text-black-65">{{ store.gauges.busd5.rewards.bnb.name }} {{ $t('global.apr') }}</span>
                    {{ store.gauges.busd5.rewards.bnb.totalApy.percent }}%
                  </span>
                </text-overlay-loading>
                <span class="icon-w-20 icon-equal mb-3"></span>
              </span>
              <text-overlay-loading class="d-flex col-auto pb-3 col-12 col-sm-auto" inline :show="store.gauges.busd5.totalApy.loading || store.gauges.busd5.maxApy.loading">
                <span class="d-flex h4 mb-0 flex-column">
                  <span class="h6 mb-0 inline-block text-black-65">{{ $t('dao.total') }} {{ $t('global.apr') }}</span>
                  {{ store.gauges.busd5.totalApy.percent }}% ~ {{ store.gauges.busd5.maxApy.percent }}%
                </span>
              </text-overlay-loading> -->
            </div>
            <div class="row mb-3 line-bottom">
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.totalStaking') }}</h6>
                <text-overlay-loading inline :show="store.gauges.busd5.mortgages.busd5.totalStaking.loading">
                  <span class="h4 mr-2">{{ store.gauges.busd5.mortgages.busd5.totalStaking.cont }}</span>
                  <span class="inline-block text-black-65">{{ store.gauges.busd5.mortgagesUnit }}</span>
                </text-overlay-loading>
              </span>
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.myStaking') }}</h6>
                <text-overlay-loading inline :show="store.gauges.busd5.mortgages.busd5.userStaking.loading">
                  <span class="h4 mr-2">{{ store.gauges.busd5.mortgages.busd5.userStaking.cont }}</span>
                  <span class="inline-block text-black-65">{{ store.gauges.busd5.mortgagesUnit }}</span>
                </text-overlay-loading>
              </span>
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.virtualPrice') }}</h6>
                <text-overlay-loading inline :show="store.tokens.busd5.price.loading">
                  <span class="h4">
                    1 <span class="h6 text-black-65">{{ store.tokens.busd5.name }} = </span>
                  </span>
                  <span class="h4">
                    {{ store.tokens.busd5.price.cont }}
                    <span class="text-black-65 h6">USD</span>
                  </span>
                </text-overlay-loading>
              </span>
              <!-- <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.rewardWeight', ['SFG']) }}</h6>
                <text-overlay-loading inline :show="store.gauges.busd5.rewards.sfg.weighting.loading">
                  <span class="h4">{{ store.gauges.busd5.rewards.sfg.weighting.percent }}%</span>
                </text-overlay-loading>
              </span> -->
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.dailyYield', ['SFG']) }}</h6>
                <text-overlay-loading inline :show="store.gauges.busd5.rewards.sfg.dailyYield.loading">
                  <span class="h4">
                    {{ store.gauges.busd5.rewards.sfg.dailyYield.cont }}
                    <span class="text-black-65 h6">{{ store.gauges.busd5.rewards.sfg.name }}</span>
                  </span>
                  <!-- <b-avatar text="!" class="iconTip iconTip-warning ml-2" id="tooltip-mining-paid-reward-tip1"></b-avatar>
                  <b-tooltip placement="topright" target="tooltip-mining-paid-reward-tip1" variant="success">{{ $t('dao.miningPoolOpeningNotice', [store.gauges.busd5.propagateMark, store.gauges.busd5.mortgagesUnit]) }}</b-tooltip> -->
                </text-overlay-loading>
              </span>
              <!-- <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.dailyYield', ['BNB']) }}</h6>
                <text-overlay-loading inline :show="store.gauges.busd5.rewards.bnb.dailyYield.loading">
                  <span class="h4">
                    {{ store.gauges.busd5.rewards.bnb.dailyYield.cont }}
                    <span class="text-black-65 h6">{{ store.gauges.busd5.rewards.bnb.name }}</span>
                  </span>
                </text-overlay-loading>
              </span> -->
            </div>
            ...
            <b-tabs pills nav-class="tabs-nav" class="mt-1">
              <b-tab :title="$t('dao.staking')" class="pt-3" active>
                ...
                <div class="row flex-wrap">
                  <div class="col-12 col-lg mt-2">
                    <b-form-input class="h-38" v-model="store.gauges.busd5.mortgages.busd5.stakeAmountInput" :placeholder="$t('dao.stakingAmountPlaceholder')"></b-form-input>
                  </div>
                  <b-form-radio-group
                    class="mt-2 col"
                    v-model="store.gauges.busd5.mortgages.busd5.stakeSliderSelectedRadio"
                    :options="store.gauges.busd5.mortgages.busd5.stakeSliderOptions"
                    buttons
                    button-variant="outline-secondary"
                  ></b-form-radio-group>
                </div>
                <small class="d-flex mt-1 flex-wrap">
                  {{ $t('dao.stakingBalance') }}：
                  <text-overlay-loading class="mr-2" :show="store.gauges.busd5.mortgages.busd5.userBalanceOf.loading">{{ store.gauges.busd5.mortgages.busd5.userBalanceOf.cont }} {{ store.gauges.busd5.mortgages.busd5.name }}</text-overlay-loading>
                  <b-button class="text-blue-1" to='/liquidity/busd5' size="xsm" variant="light">{{ $t('dao.stakingConfirmTip', [store.gauges.busd5.mortgages.busd5.name]) }}</b-button>
                </small>
                <!-- FIXME: inf_approval -->
                <b-form-checkbox class="mt-4" v-model="inf_approval" name="inf-approval">{{ $t('global.infiniteApproval') }}</b-form-checkbox>
                <b-alert class="mt-3" :show="dismissCountDown" variant="dark" dismissible fade
                ...
                <b-alert class="mt-3" :show="store.tokens.busd5.error.dismissCountDown" variant="dark" dismissible fade
                  @dismissed="store.tokens.busd5.error.dismissCountDown=0"
                  v-html='store.tokens.busd5.error.message'>
                </b-alert>

                <div class="d-flex align-items-end mt-5 float-right">
                  <text-overlay-loading :show="loadingAction">
                    <b-button size="lg" variant="danger" @click=onBusd5Stake>
                      {{ $t('dao.stakingConfirm') }}
                    </b-button>
                  </text-overlay-loading>
                </div>
              ...
              <b-tab :title="$t('dao.redemption')" class="pt-3">
                ...
                <div class="row flex-wrap">
                  <div class="col-12 col-lg mt-2">
                    <b-form-input class="h-38" v-model="store.gauges.busd5.mortgages.busd5.redemptionAmountInput" :placeholder="$t('dao.redemptionAmountPlaceholder')"></b-form-input>
                  </div>
                  <b-form-radio-group
                    class="mt-2 col"
                    v-model="store.gauges.busd5.mortgages.busd5.redemptionSliderSelectedRadio"
                    :options="store.gauges.busd5.mortgages.busd5.redemptionSliderOptions"
                    buttons
                    button-variant="outline-secondary"
                  ></b-form-radio-group>
                </div>
                <small class="d-flex mt-1">
                  {{ $t('dao.redemptionBalance') }}：
                  <text-overlay-loading :show="store.gauges.busd5.mortgages.busd5.userStaking.loading">{{ store.gauges.busd5.mortgages.busd5.userStaking.cont }} {{ store.gauges.busd5.mortgages.busd5.name }}</text-overlay-loading>
                </small>
                <!-- FIXME: inf_approval -->
                <b-form-checkbox class="mt-4" v-model="inf_approval" name="inf-approval">{{ $t('global.infiniteApproval') }}</b-form-checkbox>
                <b-alert class="mt-3" :show="dismissCountDown && waitingMessageTargetId === 'withdraw'" variant="dark" dismissible fade
                ...
                <div class="d-flex align-items-end mt-5 float-right">
                  <text-overlay-loading :show="loadingAction">
                    <b-button size="lg" variant="danger" @click=onBusd5Redemption>
                      {{ $t('dao.redemptionConfirm') }}
                    </b-button>
                  </text-overlay-loading>
                </div>
              ...
              <b-tab :title="$t('dao.miningReward')" class="pt-3">
                <div class="area">
                  <h5 class="mb-3 d-flex align-items-center">
                    <img :src="getTokenIcon(store.gauges.busd5.rewards.sfg.code)" class="mr-2 icon-w-20 icon token-icon" :class="[store.gauges.busd5.rewards.sfg.code+'-icon']">
                    {{ store.gauges.busd5.rewards.sfg.name }}
                  </h5>
                  <h6 class="mb-0 text-black-65">{{ $t('dao.miningPendingReward') }}</h6>
                  <h4 class="mb-1">
                    <text-overlay-loading inline :show="store.gauges.busd5.rewards.sfg.userPendingReward.loading">
                      {{ store.gauges.busd5.rewards.sfg.userPendingReward.cont }} {{ store.gauges.busd5.rewards.sfg.name }}
                    </text-overlay-loading>
                  </h4>
                  <div class="d-flex no-gutters align-items-end">
                    <small class="col row flex-wrap">
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningPaidReward') }}：
                        <text-overlay-loading inline :show="store.gauges.busd5.rewards.sfg.userPaidReward.loading">
                          {{ store.gauges.busd5.rewards.sfg.userPaidReward.cont }} {{ store.gauges.busd5.rewards.sfg.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningTotalReward') }}：
                        <text-overlay-loading inline :show="store.gauges.busd5.rewards.sfg.userTotalReward.loading">
                          {{ store.gauges.busd5.rewards.sfg.userTotalReward.cont }} {{ store.gauges.busd5.rewards.sfg.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <text-overlay-loading class="col-12 col-lg-auto"  inline :show="store.tokens.sfg.price.loading">
                    ...
                    <text-overlay-loading :show="loadingAction">
                      <b-button variant="danger" @click="onBusd5Harvest">
                        {{ $t('dao.miningClaimConfirm') }}
                      </b-button>
                    </text-overlay-loading>
                  </div>
                ...
                <!-- <div class="area">
                  <h5 class="mb-3 d-flex align-items-center">
                    <img :src="getTokenIcon(store.gauges.busd5.rewards.bnb.code)" class="mr-2 icon-w-20 icon token-icon" :class="[store.gauges.busd5.rewards.bnb.code+'-icon']">
                    {{ store.gauges.busd5.rewards.bnb.name }}
                  </h5>
                  <h6 class="mb-0 text-black-65">{{ $t('dao.miningPendingReward') }}</h6>
                  <h4 class="mb-1">
                    <text-overlay-loading inline :show="store.gauges.busd5.rewards.bnb.userPendingReward.loading">
                      {{ store.gauges.busd5.rewards.bnb.userPendingReward.cont }} {{ store.gauges.busd5.rewards.bnb.name }}
                    </text-overlay-loading>
                  </h4>
                  <div class="d-flex no-gutters align-items-end">
                    <small class="col row flex-wrap">
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningPaidReward') }}：
                        <text-overlay-loading inline :show="store.gauges.busd5.rewards.bnb.userPaidReward.loading">
                          {{ store.gauges.busd5.rewards.bnb.userPaidReward.cont }} {{ store.gauges.busd5.rewards.bnb.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningTotalReward') }}：
                        <text-overlay-loading inline :show="store.gauges.busd5.rewards.bnb.userTotalReward.loading">
                          {{ store.gauges.busd5.rewards.bnb.userTotalReward.cont }} {{ store.gauges.busd5.rewards.bnb.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <text-overlay-loading class="col-12 col-lg-auto"  inline :show="store.tokens.bnb.price.loading">
                        1 {{ store.tokens.bnb.name }} = {{ store.tokens.bnb.price.cont }} {{ store.tokens.bnb.priceUnit }}
                      </text-overlay-loading>
                    </small>
                    <text-overlay-loading :show="loadingAction">
                      <b-button variant="danger" @click="onBusd5ClaimRewards">
                        {{ $t('dao.miningClaimConfirm') }}
                      </b-button>
                    </text-overlay-loading>
                  </div>
          ...
          <!-- usdg5 -->
          <h4 class="mb-2 d-flex flex-wrap align-items-end">
            <span class="mr-3">{{ $t('dao.tokenTitle', [store.gauges.usdg5.propagateMark]) }}</span>
            <small class="mr-auto">{{ $t('dao.describe', [store.gauges.usdg5.mortgagesUnit, store.gauges.usdg5.rewardsUnit.join(' + ')]) }}</small>
          </h4>
          <div class="box mb-4 px-4 py-3">
            <div class="row mb-3 line-bottom flex-wrap align-items-center">
              <span class="d-md-flex d-none flex-wrap align-items-center">
                ...
                <span class="icon-w-20 icon-plus mb-3"></span>
                <text-overlay-loading class="d-flex col-auto pb-3 col-12 col-sm-auto" inline :show="store.gauges.usdg5.rewards.gt.totalApy.loading">
                  <img :src="getTokenIcon(store.gauges.usdg5.rewards.gt.code)" class="mr-2 icon-w-48 icon" :class="[store.gauges.usdg5.rewards.sfg.code+'-icon']">
                  <span class="d-flex h4 mb-0 flex-column">
                    <span class="h6 mb-0 inline-block text-black-65">{{ store.gauges.usdg5.rewards.gt.name }} {{ $t('global.apr') }}</span>
                    {{ store.gauges.usdg5.rewards.gt.totalApy.percent }}%
                  </span>
                </text-overlay-loading>
                <span class="icon-w-20 icon-equal mb-3"></span>
              </span>
            ...
            <div class="row mb-3 line-bottom">
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.totalStaking') }}</h6>
                <text-overlay-loading inline :show="store.gauges.usdg5.mortgages.usdg5.totalStaking.loading">
                  <span class="h4 mr-2">{{ store.gauges.usdg5.mortgages.usdg5.totalStaking.cont }}</span>
                  <span class="inline-block text-black-65">{{ store.gauges.usdg5.mortgagesUnit }}</span>
                </text-overlay-loading>
              </span>
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.myStaking') }}</h6>
                <text-overlay-loading inline :show="store.gauges.usdg5.mortgages.usdg5.userStaking.loading">
                  <span class="h4 mr-2">{{ store.gauges.usdg5.mortgages.usdg5.userStaking.cont }}</span>
                  <span class="inline-block text-black-65">{{ store.gauges.usdg5.mortgagesUnit }}</span>
                </text-overlay-loading>
              </span>
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.virtualPrice') }}</h6>
                <text-overlay-loading inline :show="store.tokens.usdg5.price.loading">
                  <span class="h4">
                    1 <span class="h6 text-black-65">{{ store.tokens.usdg5.name }} = </span>
                  </span>
                  <span class="h4">
                    {{ store.tokens.usdg5.price.cont }}
                    <span class="text-black-65 h6">USD</span>
                  </span>
                </text-overlay-loading>
              </span>
              <!-- <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.rewardWeight', ['SFG']) }}</h6>
                <text-overlay-loading inline :show="store.gauges.usdg5.rewards.sfg.weighting.loading">
                  <span class="h4">{{ store.gauges.usdg5.rewards.sfg.weighting.percent }}%</span>
                </text-overlay-loading>
              </span> -->
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.dailyYield', ['SFG']) }}</h6>
                <text-overlay-loading inline :show="store.gauges.usdg5.rewards.sfg.dailyYield.loading">
                  <span class="h4">
                    {{ store.gauges.usdg5.rewards.sfg.dailyYield.cont }}
                    <span class="text-black-65 h6">{{ store.gauges.usdg5.rewards.sfg.name }}</span>
                  </span>
                  <!-- <b-avatar text="!" class="iconTip iconTip-warning ml-2" id="tooltip-mining-paid-reward-tip1"></b-avatar>
                  <b-tooltip placement="topright" target="tooltip-mining-paid-reward-tip1" variant="success">{{ $t('dao.miningPoolOpeningNotice', [store.gauges.usdg5.propagateMark, store.gauges.usdg5.mortgagesUnit]) }}</b-tooltip> -->
                </text-overlay-loading>
              </span>
              <span class="col-12 col-md-6 pb-3">
                <h6 class="mb-0 text-black-65">{{ $t('dao.dailyYield', ['GT']) }}</h6>
                <text-overlay-loading inline :show="store.gauges.usdg5.rewards.gt.dailyYield.loading">
                  <span class="h4">
                    {{ store.gauges.usdg5.rewards.gt.dailyYield.cont }}
                    <span class="text-black-65 h6">{{ store.gauges.usdg5.rewards.gt.name }}</span>
                  </span>
                  <!-- <b-avatar text="!" class="iconTip iconTip-warning ml-2" id="tooltip-mining-paid-reward-tip2"></b-avatar>
                  <b-tooltip placement="topright" target="tooltip-mining-paid-reward-tip2" variant="success">{{ $t('dao.miningPoolOpeningNotice', [store.gauges.usdg5.propagateMark, store.gauges.usdg5.mortgagesUnit]) }}</b-tooltip> -->
                </text-overlay-loading>
              </span>
            </div>
            ...
            <b-tabs pills nav-class="tabs-nav" class="mt-1">
              <b-tab :title="$t('dao.staking')" class="pt-3" active>
                ...
                <div class="row flex-wrap">
                  <div class="col-12 col-lg mt-2">
                    <b-form-input class="h-38" v-model="store.gauges.usdg5.mortgages.usdg5.stakeAmountInput" :placeholder="$t('dao.stakingAmountPlaceholder')"></b-form-input>
                  </div>
                  <b-form-radio-group
                    class="mt-2 col"
                    v-model="store.gauges.usdg5.mortgages.usdg5.stakeSliderSelectedRadio"
                    :options="store.gauges.usdg5.mortgages.usdg5.stakeSliderOptions"
                    buttons
                    button-variant="outline-secondary"
                  ></b-form-radio-group>
                </div>
                <small class="d-flex mt-1 flex-wrap">
                  {{ $t('dao.stakingBalance') }}：
                  <text-overlay-loading class="mr-2" :show="store.gauges.usdg5.mortgages.usdg5.userBalanceOf.loading">{{ store.gauges.usdg5.mortgages.usdg5.userBalanceOf.cont }} {{ store.gauges.usdg5.mortgages.usdg5.name }}</text-overlay-loading>
                  <b-button class="text-blue-1" to='/liquidity/usdg5' size="xsm" variant="light">{{ $t('dao.stakingConfirmTip', [store.gauges.usdg5.mortgages.usdg5.name]) }}</b-button>
                </small>
                <!-- FIXME: inf_approval -->
                <b-form-checkbox class="mt-4" v-model="inf_approval" name="inf-approval">{{ $t('global.infiniteApproval') }}</b-form-checkbox>
                <b-alert class="mt-3" :show="dismissCountDown" variant="dark" dismissible fade
                ...
                <b-alert class="mt-3" :show="store.tokens.usdg5.error.dismissCountDown" variant="dark" dismissible fade
                  @dismissed="store.tokens.usdg5.error.dismissCountDown=0"
                  v-html='store.tokens.usdg5.error.message'>
                </b-alert>

                <div class="d-flex align-items-end mt-5 float-right">
                  <text-overlay-loading :show="loadingAction">
                    <b-button size="lg" variant="danger" @click=onUsdg5Stake>
                      {{ $t('dao.stakingConfirm') }}
                    </b-button>
                  </text-overlay-loading>
                </div>
              ...
              <b-tab :title="$t('dao.redemption')" class="pt-3">
                ...
                <div class="row flex-wrap">
                  <div class="col-12 col-lg mt-2">
                    <b-form-input class="h-38" v-model="store.gauges.usdg5.mortgages.usdg5.redemptionAmountInput" :placeholder="$t('dao.redemptionAmountPlaceholder')"></b-form-input>
                  </div>
                  <b-form-radio-group
                    class="mt-2 col"
                    v-model="store.gauges.usdg5.mortgages.usdg5.redemptionSliderSelectedRadio"
                    :options="store.gauges.usdg5.mortgages.usdg5.redemptionSliderOptions"
                    buttons
                    button-variant="outline-secondary"
                  ></b-form-radio-group>
                </div>
                <small class="d-flex mt-1">
                  {{ $t('dao.redemptionBalance') }}：
                  <text-overlay-loading :show="store.gauges.usdg5.mortgages.usdg5.userStaking.loading">{{ store.gauges.usdg5.mortgages.usdg5.userStaking.cont }} {{ store.gauges.usdg5.mortgages.usdg5.name }}</text-overlay-loading>
                </small>
                <!-- FIXME: inf_approval -->
                <b-form-checkbox class="mt-4" v-model="inf_approval" name="inf-approval">{{ $t('global.infiniteApproval') }}</b-form-checkbox>
                <b-alert class="mt-3" :show="dismissCountDown && waitingMessageTargetId === 'withdraw'" variant="dark" dismissible fade
                ...
                <div class="d-flex align-items-end mt-5 float-right">
                  <text-overlay-loading :show="loadingAction">
                    <b-button size="lg" variant="danger" @click=onUsdg5Redemption>
                      {{ $t('dao.redemptionConfirm') }}
                    </b-button>
                  </text-overlay-loading>
                </div>
              ...
              <b-tab :title="$t('dao.miningReward')" class="pt-3">
                <div class="area">
                  <h5 class="mb-3 d-flex align-items-center">
                    <img :src="getTokenIcon(store.gauges.usdg5.rewards.sfg.code)" class="mr-2 icon-w-20 icon token-icon" :class="[store.gauges.usdg5.rewards.sfg.code+'-icon']">
                    {{ store.gauges.usdg5.rewards.sfg.name }}
                  </h5>
                  <h6 class="mb-0 text-black-65">{{ $t('dao.miningPendingReward') }}</h6>
                  <h4 class="mb-1">
                    <text-overlay-loading inline :show="store.gauges.usdg5.rewards.sfg.userPendingReward.loading">
                      {{ store.gauges.usdg5.rewards.sfg.userPendingReward.cont }} {{ store.gauges.usdg5.rewards.sfg.name }}
                    </text-overlay-loading>
                  </h4>
                  <div class="d-flex no-gutters align-items-end">
                    <small class="col row flex-wrap">
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningPaidReward') }}：
                        <text-overlay-loading inline :show="store.gauges.usdg5.rewards.sfg.userPaidReward.loading">
                          {{ store.gauges.usdg5.rewards.sfg.userPaidReward.cont }} {{ store.gauges.usdg5.rewards.sfg.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningTotalReward') }}：
                        <text-overlay-loading inline :show="store.gauges.usdg5.rewards.sfg.userTotalReward.loading">
                          {{ store.gauges.usdg5.rewards.sfg.userTotalReward.cont }} {{ store.gauges.usdg5.rewards.sfg.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <text-overlay-loading class="col-12 col-lg-auto"  inline :show="store.tokens.sfg.price.loading">
                    ...
                    <text-overlay-loading :show="loadingAction">
                      <b-button variant="danger" @click="onUsdg5Harvest">
                        {{ $t('dao.miningClaimConfirm') }}
                      </b-button>
                    </text-overlay-loading>
                  </div>
                ...
                <div class="area">
                  <h5 class="mb-3 d-flex align-items-center">
                    <img :src="getTokenIcon(store.gauges.usdg5.rewards.gt.code)" class="mr-2 icon-w-20 icon token-icon" :class="[store.gauges.usdg5.rewards.gt.code+'-icon']">
                    {{ store.gauges.usdg5.rewards.gt.name }}
                  </h5>
                  <h6 class="mb-0 text-black-65">{{ $t('dao.miningPendingReward') }}</h6>
                  <h4 class="mb-1">
                    <text-overlay-loading inline :show="store.gauges.usdg5.rewards.gt.userPendingReward.loading">
                      {{ store.gauges.usdg5.rewards.gt.userPendingReward.cont }} {{ store.gauges.usdg5.rewards.gt.name }}
                    </text-overlay-loading>
                  </h4>
                  <div class="d-flex no-gutters align-items-end">
                    <small class="col row flex-wrap">
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningPaidReward') }}：
                        <text-overlay-loading inline :show="store.gauges.usdg5.rewards.gt.userPaidReward.loading">
                          {{ store.gauges.usdg5.rewards.gt.userPaidReward.cont }} {{ store.gauges.usdg5.rewards.gt.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <span class="col-12 col-lg-auto">
                        {{ $t('dao.miningTotalReward') }}：
                        <text-overlay-loading inline :show="store.gauges.usdg5.rewards.gt.userTotalReward.loading">
                          {{ store.gauges.usdg5.rewards.gt.userTotalReward.cont }} {{ store.gauges.usdg5.rewards.gt.name }}
                        </text-overlay-loading>
                        <em class="px-3 text-black-15">/</em>
                      </span>
                      <text-overlay-loading class="col-12 col-lg-auto"  inline :show="store.tokens.gt.price.loading">
                        1 {{ store.tokens.gt.name }} = {{ store.tokens.gt.price.cont }} {{ store.tokens.gt.priceUnit }}
                      </text-overlay-loading>
                    </small>
                    <text-overlay-loading :show="loadingAction">
                      <b-button variant="danger" @click="onUsdg5ClaimRewards">
                        {{ $t('dao.miningClaimConfirm') }}
                      </b-button>
                    </text-overlay-loading>
                  </div>
            ...
            <div class="row mb-3 line-bottom flex-wrap align-items-center">
              <span class="d-md-flex d-none flex-wrap align-items-center">
                ...
                <text-overlay-loading class="d-flex col-auto pb-3 col-12 col-sm-auto" inline :show="store.gauges.susdv2.rewards.crv.totalApy.loading">
                  ...
                  <span class="d-flex h4 mb-0 flex-column">
                    <span class="h6 mb-0 inline-block text-black-65">{{ store.gauges.susdv2.rewards.crv.name }} {{ $t('global.apr') }} + {{ store.gauges.susdv2.rewards.snx.name }} {{ $t('global.apr') }}</span>
    ...
    export default {
        ...
        methods: {
          ...
          async onUsdg5Stake () {
            ...
            if (!await tokens.usdg5.hasValidAmount(gauges.usdg5.mortgages.usdg5.userStake.revised)) return false

            if (await tokens.usdg5.hasApprove(gauges.usdg5.mortgages.usdg5.userStake.revised, currentContract.default_account, gauges.usdg5.address)) {
              gauges.usdg5.onStake(currentContract.default_account, this.inf_approval)
            } else {
              tokens.usdg5.onApproveAmount(gauges.usdg5.mortgages.usdg5.userStake.revised, currentContract.default_account, gauges.usdg5.address, this.inf_approval)
            }
          },
          async onUsdg5Redemption () {
            store.gauges.usdg5.onRedemption(currentContract.default_account, this.inf_approval)
          },
          async onUsdg5Harvest () {
            store.gauges.usdg5.onHarvest(currentContract.default_account)
          },
          async onUsdg5ClaimRewards () {
            store.gauges.usdg5.onClaimRewards(currentContract.default_account)
          },
          ...
          async onBusd5Stake () {
            ...
            if (!await tokens.busd5.hasValidAmount(gauges.busd5.mortgages.busd5.userStake.revised)) return false

            if (await tokens.busd5.hasApprove(gauges.busd5.mortgages.busd5.userStake.revised, currentContract.default_account, gauges.busd5.address)) {
              gauges.busd5.onStake(currentContract.default_account, this.inf_approval)
            } else {
              tokens.busd5.onApproveAmount(gauges.busd5.mortgages.busd5.userStake.revised, currentContract.default_account, gauges.busd5.address, this.inf_approval)
            }
          },
          async onBusd5Redemption () {
            store.gauges.busd5.onRedemption(currentContract.default_account, this.inf_approval)
          },
          async onBusd5Harvest () {
            store.gauges.busd5.onHarvest(currentContract.default_account)
          },
          async onBusd5ClaimRewards () {
          ...
          async mounted() {
            ...
            // store.gauges.busd5.getMaxApy(
              store.gauges.busd5.getAPY(
                sfgPrice,
                sfgDailyYield,
                busd5.getTotalStaking(busd5.mortgages.busd5.totalStaking), // busd5.getVirtualTotalSupply(),
                store.tokens.busd5.getPrice(),
                store.tokens.bnb.getPrice(),
              ),
            //   multiple
            // )

            store.tokens.busd5.getBalanceOf(busd5.mortgages.busd5.userBalanceOf, currentContract.default_account)

            busd5.getBalanceOf(busd5.mortgages.busd5.userStaking, currentContract.default_account)

            busd5.getUserTotalReward_SFG(
              busd5.rewards.sfg.userTotalReward,
              busd5.getUserPendingReward_SFG(busd5.rewards.sfg.userPendingReward, currentContract.default_account),
              busd5.getUserPaidReward_SFG(busd5.rewards.sfg.userPaidReward, currentContract.default_account)
            )

            busd5.getUserTotalReward_BNB(
              busd5.rewards.bnb.userTotalReward,
              busd5.getUserPendingReward_BNB(busd5.rewards.bnb.userPendingReward, currentContract.default_account),
              busd5.getUserPaidReward_BNB(busd5.rewards.bnb.userPaidReward, currentContract.default_account)
            )
            ...
            usdg5.getBalanceOf(usdg5.mortgages.usdg5.userStaking, currentContract.default_account)

            usdg5.getUserTotalReward_SFG(
              usdg5.rewards.sfg.userTotalReward,
              usdg5.getUserPendingReward_SFG(usdg5.rewards.sfg.userPendingReward, currentContract.default_account),
              usdg5.getUserPaidReward_SFG(usdg5.rewards.sfg.userPaidReward, currentContract.default_account)
            )
