...
export const OWNERSHIP_APP_ADDRESS = process.env.VUE_APP_OWNERSHIP_APP_ADDRESS
export const PARAMETER_APP_ADDRESS = process.env.VUE_APP_PARAMETER_APP_ADDRESS
export const OWNERSHIP_AGENT = process.env.VUE_APP_OWNERSHIP_AGENT
export const PARAMETER_AGENT = process.env.VUE_APP_PARAMETER_AGENT
