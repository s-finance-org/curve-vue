      ...
      computed: {
        ...
        acceleration () {
          ...
          const result = {
            ...
            dfi: {
              _gauges: gauges.dfi,
              _mortgage: gauges.dfi.mortgages.iUSD_LPT,
            },
            bpt: {
              _gauges: gauges.bpt,
        ...
        methods: {
          ...
          async mounted() {
            ...
            gauges.dfi.getNeedLockAmount(
              ...
              lock.SFG.getStakingPerLPT(gauges.dfi.address),
              gauges.dfi.getBalanceOf(gauges.dfi.mortgages.iUSD_LPT.userStaking, walletAddress),
              sfgBalanceOf,
            )
