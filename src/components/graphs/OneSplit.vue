        ...
        computed: {
          ...
          messages () {
            ...
            bestPoolText() {
                ...
                return ['compound', 'y', 'busd', 'susd', 'pax', 'ren', 'sbtc', '1split', 'dfi', 'dusd', 'okuu', 'usd5', 'qusd5', 'usdg5'][this.bestPool]
            },
            selldisabled() {
            ...
            async set_to_amount() {
                ...
                try {
                    ...
                    if([3,4,5,6].includes(this.from_currency) && [3,4,5,6].includes(this.to_currency)) {
                        ...
                        let pools = ['compound', 'iearn', 'busd', 'susdv2', 'pax', 'ren', 'sbtc', '1split', 'dfi', 'dusd', 'okuu', 'usd5', 'qusd5', 'usdg5']
                        this.swapPromise.cancel()
