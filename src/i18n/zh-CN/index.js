...
export default {
  ...
  statement: {
    ...
    comingCont1: 'S.Finance 将于新加坡时间 2020-09-22 21:22:22 开启 susd 流动性矿池抵押挖矿。 抵押 susdv2 LP tokens 即可获得 S.Finance 治理代币 SFG、Curve 治理代币 CRV 以及 Synthetix 平台代币 SNX。',
  ...
  risk: {
    ...
    lossTitle: '资产损失',
    lossContHtml: 'S.finance 智能合约通过了知道创宇审计。<br/>然而，安全审计并不能完全消除风险。请在能力承受范围内投资，不要盲目投入全部资产，尤其是在提供流动性时。<br/>使用S.finance作兑换交易时风险会相对降低，但这只是建议。',
    stakingTitle: '抵押风险',
