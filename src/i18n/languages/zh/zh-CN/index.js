...
export default {
  ...
  statement: {
    more: '查看详情',
    ok: '知道了',
    noticeTitleHtml: 'S.Finance 已开启 SFG 流动性挖矿',
    noticeContHtml: `S.Finance 将于新加坡时间 2020-09-25 20:00 开启 SFG 流动性矿池抵押挖矿，抵押 BPT 即可获得 S.Finance 治理代币 SFG 奖励。SFG 兑换以及存取款服务由 Balancer 提供，其中：<br/>
