...
var qusd5 = {
  ...
  N_COINS: 2,
  // coin_precisions: [1e18, 1e18, 1e6, 1e6, 1e18, 1e18],
  // wrapped_precisions: [1e18, 1e18, 1e6, 1e6, 1e18, 1e18],
  // tethered: [false, false, false, true, false, false],
  // use_lending: [false, false, false, false, true, false],
  // is_plain: [true, true, true, true, true, true],
  coin_precisions: [1e18, 1e18],
