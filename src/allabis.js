...
var basu = {
  ...
  use_lending: [false, false],
  is_plain: [true, true],
  swap_address: process.env.VUE_APP_BASU_SWAP,
  token_address: process.env.VUE_APP_BASU_TOKEN,
  infura_url: `https://${process.env.VUE_APP_INFURA_ENDPOINTS_DOMIAN}/v3/${process.env.VUE_APP_INFURA_KEY}`,
  deposit_address: process.env.VUE_APP_BASU_DEPOSIT,
  underlying_coins: [
    process.env.VUE_APP_BAC_TOKEN,
    process.env.VUE_APP_DAI_TOKEN
  ],
  coins: [
    process.env.VUE_APP_BAC_TOKEN,
